...
INSERT INTO `npo_registers` VALUES (1,'2hj','Second Harvest Japan','å…¨ã¦ã®äººã«ã€é£Ÿã¹ç‰©ã‚’ã€‚','facebook.com','twitter.com','','','','','https://bitflyer.jp/EasyPay/PAP20180118-210717-200008','https://bitflyer.jp/easypayp/2aRk37',NULL,'manalangaoka',NULL,NULL,NULL,NULL,0,0,'ç§ãŸã¡ã®ç›®æ¨™ã€€ãƒ•ãƒ¼ãƒ‰ã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒãƒƒãƒˆã®æ§‹ç¯‰\r\n\r\nèª°ã‚‚ãŒå®‰å…¨ã§æ „é¤Šã®ã‚ã‚‹é£Ÿå“ã‚’æ‰‹ã«ã™ã‚‹ã“ã¨ãŒã§ãã‚‹ã€‚ ã“ã‚ŒãŒåŸºæœ¬çš„ãªã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒãƒƒãƒˆã®ä¸€éƒ¨ã§ã‚ã‚‹ã¹ãã ã¨ç§ãŸã¡ã¯è€ƒãˆã¦ã„ã¾ã™ã€‚ ãã‚Œã¯ç¤¾ä¼šä¿éšœã®åˆ¶åº¦ã¯ã‚‚ã¡ã‚ã‚“ã€ä¾‹ãˆã°åœ°åŸŸã§å›°ã£ãŸæ™‚ã«ç›¸è«‡ã«ã®ã‚‹äº¤ç•ªã®å­˜åœ¨ã®ã‚ˆã†ã«ã€æ€ªæˆ‘ã‚„ç—…æ°—ã®éš›ã«æ²»ç™‚ãŒå—ã‘ã‚‰ã‚Œã‚‹ç—…é™¢ã®ã‚ˆã†ã«ã€ç«äº‹ã®æ™‚ã«æ¶ˆç«æ´»å‹•ã‚’è¡Œã†æ¶ˆé˜²ç½²ã®ã‚ˆã†ã«ã€‚ ã„ã¤ã§ã‚‚ä½ã‚“ã§ã„ã‚‹åœ°åŸŸã«ã¦ç·Šæ€¥é£Ÿæ–™æ”¯æ´ã‚’å—ã‘ã‚‰ã‚Œã‚‹ã€‚ã‚»ã‚«ãƒ³ãƒ‰ãƒãƒ¼ãƒ™ã‚¹ãƒˆãƒ»ã‚¸ãƒ£ãƒ‘ãƒ³ã§ã¯ã€ãã‚“ãªã€Œé£Ÿã€ã®ã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒãƒƒãƒˆã‚’æ§‹ç¯‰ã—ã¾ã™ã€‚\r\n\r\nãƒ•ãƒ¼ãƒ‰ã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒãƒƒãƒˆã®æ§‹ç¯‰\r\n\r\nç¤¾ä¼šã®èª°ã‹ã‚‰ã‚‚åŠ©ã‘ã‚’å¾—ã‚‰ã‚Œãšã€é£Ÿã¹ç‰©ã«å›°ã‚‹çŠ¶æ…‹ã«ãªã£ã¦ã—ã¾ã£ãŸäººã« ç›´æ¥é£Ÿæ–™ã‚’å±Šã‘ã‚‹ãƒãƒ¼ãƒ™ã‚¹ãƒˆãƒ‘ãƒ³ãƒˆãƒªãƒ¼æ´»å‹•ã‚’æ‹¡å¤§ã—ã€ é£Ÿæ–™ã«é–¢ã™ã‚‹ã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒ¼ãƒãƒƒãƒˆï¼ãƒ•ãƒ¼ãƒ‰ã‚»ãƒ¼ãƒ•ãƒ†ã‚£ãƒ¼ãƒãƒƒãƒˆã®æ§‹ç¯‰ã‚’ç›®æŒ‡ã—ã¾ã™ã€‚\r\n\r\nãƒ•ãƒ¼ãƒ‰ãƒ©ã‚¤ãƒ•ãƒ©ã‚¤ãƒ³ã®å¼·åŒ–\r\n\r\né£Ÿå“ã‚’æä¾›ã™ã‚‹ä¼æ¥­ã¨ã€å—ã‘å–ã‚‹æ–½è¨­ãƒ»å›£ä½“ãŒãƒ•ãƒ¼ãƒ‰ãƒãƒ³ã‚¯ã‚’ã‚ˆã‚Šåˆ©ç”¨ã—ã‚„ã™ããªã‚‹ã‚ˆã†æ§˜ã€…ãªå–ã‚Šçµ„ã¿ã‚’è¡Œã„ã¾ã™ã€‚ç‰¹ã«é‡è¦è¦–ã—ã¦ã„ã‚‹ã®ã¯ã€æµé€šä¼æ¥­ã€é£Ÿå“ä¼æ¥­ã‚„ç‰©æµé–¢é€£ä¼æ¥­ãªã©ã®å”åŠ›ã‚’å¾—ãªãŒã‚‰ã€ãƒ•ãƒ¼ãƒ‰ãƒãƒ³ã‚¯ã®åŸºå¹¹æµé€šã‚’ã¤ãã‚‹ã“ã¨ã§ã™ã€‚',NULL,'2018-01-18 09:34:11','2018-01-19 06:08:11');
...
INSERT INTO `users` VALUES (1,'test','test@test.co.jp','$2y$10$VNnec6nTP0OpNeergjQfg.UT5ogBKWCky0W3bP3Yn1sQyswGbFD6q','zZJ3jE8vK5G5UWAVmJ09zTs4QotIgm9yhf998bNTmmnigX7xw1RwGLwM7G3y','2018-01-16 22:54:55','2018-01-16 23:17:50'),(2,'nakajoTakayuki','nj.takayuki+004@gmail.com','$2y$10$MZw1zJkkvZ.h8xQ9PdvvheQ7l4KqW7goK1H8.cvujiFwkgCaWCFma','3S6a3OepKAxJIIasQ6XpJQzbLE4P4GfOoZw8AolVK3cos3h2WU0zrviuvLnn','2018-01-16 23:16:48','2018-01-18 14:50:12'),(3,'test2','test2@test.co.jp','$2y$10$7B7lkagbi9UAXBEFteE.HeYZ9kinrYy.vrFPVAKaK5DRC3OXFuxIe','gXyRFBhf11w1z23Bhd3XiLhuNSLH2456KKfVjZQCO2taExhcuVmcavyx7AWN','2018-01-16 23:18:13','2018-01-16 23:38:50'),(4,'ã–ãã‚„ã¾','yamazaki_daisuke@hotmail.co.jp','$2y$10$y0bvyoGR19MCAZczuGBpk.1HlW12ZcaNe4uliMWoW6wfkMnqgcEO6',NULL,'2018-01-17 23:14:30','2018-01-17 23:14:30'),(5,'kinokino','kino@gmail.com','$2y$10$Z4sVO3BZcRpqk3ZHSMm9XeZalcp4lJM542aNuTV6i0ZyboqZgqJUa',NULL,'2018-01-17 23:18:38','2018-01-17 23:18:38'),(6,'manalangaoka','manalangaoka@gmail.com','$2y$10$pNX4cs3ll6cK9lYTVd0G3e1NYjYJhFzieypAEbvIpAbXYR84NHU4W','WMR3wQxsBuWFcbO7H8phGImLXnQFj8eKWze9aHEMeR5rZH2wgvClw9CQfMFi','2018-01-18 05:02:29','2018-01-19 23:14:41'),(7,'nj','nj.takayuki+005@gmail.com','$2y$10$Z7PSG94DJ/z8ZxsrMsUlx.o0BWAbJuiXg6eNQpOW0oyhAP.QAufiO','hgHItEtLNoMMovsJTTmcQCHoKsi0ntwOQtH84Z1nuwUF6vl7gfq7G0Mp4cpq','2018-01-18 14:51:01','2018-01-18 14:51:48'),(8,'nj','nj.takayuki+006@gmail.com','$2y$10$U.tnhx1HT/zqzCIbru7wTe/4LRZJs74or4Vp7ktsUZyRQrk4Neuru','BsZaFjP0w4UO53rscPTbrnIhyFPQ6rONzynDO1UcpHbCQ3WzDXWNcxv7nIDv','2018-01-18 14:52:29','2018-01-19 05:41:33'),(9,'nj','nj.takayuki+007@gmail.com','$2y$10$36/cnBpxl7iQvmnhu5/riOFRmhC.6zhtOROCixCBIiHyBaj1mqdTu','5xFoBL9VslKSTd0c3BjKuK0UwenMa3qsYIHEWm50kQ2gGBromN6CwI3UCahk','2018-01-18 14:57:08','2018-01-18 15:10:36'),(10,'manalang','manalang@gmail.com','$2y$10$VRtT6uZqSYLCf5oA4BQgxuZ7JyG93GWRg5yDjgdR/te2DwcUJedSu','rZkWQV5XXZs0BGP2rmswlnfyPje1zHELUpGbg9teJl7NbshDbpwNNasUOcre','2018-01-18 15:11:46','2018-01-18 15:23:41'),(11,'å¯ºç”°å„ªä¹Ÿ','unitednum@gmail.com','$2y$10$PHtRmzR1ui1ow59nxXZ0ZedM6Fm.ulxS/se5d5x8exgbOa2K9Ncxa','v0d04I1H4IzzW6tD2xNlSL8rEgQsumAZHJTA9TyibYfGL57UgKolCgxxxcsY','2018-01-18 17:44:52','2018-01-18 17:47:30'),(12,'mana','mana@gmail.com','$2y$10$HY2WUPEdLFAfb.qXXhRdce2vDg7MTSfTAeQZX8G1uKrp1jom2BpZK','HDiR7mtTGq2BTqzpQRqatfqW52EkVufhOYpq29E5130a1FP0AFfcufOIPGW7','2018-01-19 05:42:58','2018-01-19 05:58:39');
...
CREATE TABLE `vision_data` (
  ...
  `first_commitment_stage` int(10) unsigned NOT NULL,
  `second_commitment_stage` int(10) unsigned NOT NULL,
  `delflg` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `vision_data` VALUES (1,'test@test.co.jp','1','ã‚¿ã‚¤ãƒˆãƒ«','','open','2018-01-16 22:56:33','ã‚¿ã‚¤ãƒˆãƒ«è©³ç´°',100000,200000,'0',NULL,NULL),(2,'kino@gmail.com','1','æœ¨ä¸‹å‹Ÿé‡‘','','open','2018-01-17 23:19:42','ã¨ã‚Šã‚ãˆãšé‡‘ãã‚Œ',1000000,10000000,'0',NULL,NULL);
...
-- Dump completed on 2018-01-19 22:22:40
