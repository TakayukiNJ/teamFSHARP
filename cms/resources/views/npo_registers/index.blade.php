                    ...
                    <tbody>
                        @foreach($npo_registers as $npo_register)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-xs btn-primary" href="{{ url('/npo') }}/{{ $npo_register->npo_name }}"><h1><i class="glyphicon glyphicon-eye-open"></i> 公開画面</h1></a>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('/npo') }}/{{ $npo_register->npo_name }}"><h1>{{$npo_register->subtitle}}（期限切れ）</h1></a></td>
