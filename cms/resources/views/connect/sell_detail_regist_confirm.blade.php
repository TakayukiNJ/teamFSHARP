...
<!--                 <div class="form-group">
            ...
            <div class="well well-sm">
                <button type="button" class="btn btn-primary" onClick="E04_3_run()">登録(審査期間:約1週間)</button>
...
/* 新VISION登録確認画面 */
function E04_3_run() {
    window.document.changeform.action = "{{ url('connect/sell_detail_regist_process') }}";
